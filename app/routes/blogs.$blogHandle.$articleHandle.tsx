...
import {injectFaqSections} from '~/components/FaqSection';
import {injectTwoColumnContent} from '~/components/TwoColumnContent';
import {withHeadingIds, TableOfContents, isTocEnabled} from '~/components/TableOfContents';
import {AuthorSection, getAuthorSectionData} from '~/components/AuthorSection';
import SocialShare, {isSocialShareEnabled} from '~/components/SocialShare';
...
import RelatedBlogPosts, {
  getRelatedPostsData,
} from '~/components/RelatedBlogPosts';
import {
...
import Video, {injectVideoEmbeds, readVideoSlot} from '~/components/Video';
import ImagesGallery, {
  injectImagesGallery,
  readGallerySlot,
  type GalleryImage,
} from '~/components/ImagesGallery';
import {injectBlogButtons} from '~/components/Button';
import {injectQuoteEmbeds} from '~/components/Quote';
import {injectRecipeHeader} from '~/components/RecipeHeader';
import {
