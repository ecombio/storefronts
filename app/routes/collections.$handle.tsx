...
import type {SponsoredAdsData} from '~/components/PromoCarousel';
import {PromoBanner} from '~/components/PromoBanner';
import type {PromoBannerData} from '~/components/PromoBanner';
...
export default function Collection() {
  ...
  // ~/components/PromoCarousel.tsx. Every field below is optional;
  ...
  // grid — see CollectionFeed -> ~/components/PromoBanner.tsx.
...
function PriceRangeFilterGroup({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-lib/exhaustive-deps
