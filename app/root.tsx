...
import productSectionsStyles from '~/components/blogs/product-sections.css?url';
import productCarouselStyles from '~/assets/product-carousel.css?url';
import promoCarouselStyles from '~/assets/promo-carousel.css?url';
import promoCardStyles from '~/assets/promo-card.css?url';
import promoBannerStyles from '~/assets/promo-banner.css?url';
...
import paginationStyles from '~/assets/pagination.css?url';
...
import quickviewStyles from '~/assets/quickview.css?url';
import compareBarStyles from '~/assets/compare-bar.css?url';
import comparePageStyles from '~/assets/compare-page.css?url';
import wishlistPageStyles from '~/assets/wishlist-page.css?url';
