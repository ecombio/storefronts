...
/* ════════════════════════════════════════════════════════════════════════
 * Inlined from app/lib/Header.constants.ts
 * ════════════════════════════════════════════════════════════════════════
...
// ─────────────────────────────────────────────────────────────────────────
// Announcement bar
// Stand-in for components/announcement-bar.liquid's ann_1..ann_5 settings.
...
// ─────────────────────────────────────────────────────────────────────────
// Utility bar
// Stand-in for components/utility-bar.liquid's link_1..link_3 settings.
// ─────────────────────────────────────────────────────────────────────────
...
// top-level menu item title. Mirrors components/showcase-block.liquid's
...
/* ════════════════════════════════════════════════════════════════════════
 * Inlined from app/components/ai-search-svg-paths.ts
 * ════════════════════════════════════════════════════════════════════════ */
const svgPaths = {
...
/* ════════════════════════════════════════════════════════════════════════
 * Inlined from app/lib/useHeaderHeightSync.ts
 * ════════════════════════════════════════════════════════════════════════
