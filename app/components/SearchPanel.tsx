...
export function SearchPanel({
  ...
  // Panel now always covers the entire viewport starting from the very
  // top (y: 0) — including AnnouncementBar and UtilityBar above the
  // logo/search/cta row — rather than starting just below the header's
  // search row. Previously this was measured dynamically via
  // useHeaderBottom + `[data-header-search-row]`; that's no longer
  // needed since the panel is intentionally a full top-to-bottom overlay.
  const topOffset = 0;
            ...
            <div className="flex items-center gap-4">
              <div className="relative flex-1">
                <input
                  ...
                  className="h-12 w-full rounded-full bg-gray-100 pl-5 pr-5 text-[15px] outline-none placeholder:text-gray-500 focus:bg-gray-50 focus:ring-2 focus:ring-gray-900"
                />
              </div>
              <button
                type="button"
